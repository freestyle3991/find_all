...
+ (nonnull NSString *)carparksNearbyLayerId;
...
+ (nonnull NSString *)toponymPhotoLayerId;

+ (nonnull NSString *)drivingNavigationLayerId;

+ (nonnull NSString *)routePinsLayerId;

+ (nonnull NSString *)mrcPhotoAutomotiveLayerId;

+ (nonnull NSString *)mrcPhotoAutomotiveAgeLayerId;

+ (nonnull NSString *)mrcPhotoPedestrianLayerId;

+ (nonnull NSString *)mrcPhotoPedestrianAgeLayerId;
